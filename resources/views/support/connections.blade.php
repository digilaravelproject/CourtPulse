        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($connected as $connection)
                <div class="group relative rounded-2xl bg-navy border border-white/5 p-6 hover:border-blue/30 hover:bg-white/3 transition-all duration-500">
                    ...
                    <a href="{{ route('support.advocate.profile', $connection->id) }}" class="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-white/5 border border-white/10 text-[10px] font-black text-white uppercase tracking-widest hover:bg-blue hover:text-navy hover:border-blue transition-all duration-300">
            ...
            @empty
                <div class="col-span-full py-20 flex flex-col items-center justify-center text-center">
                    ...
                    <p class="text-sm font-bold text-white/40 uppercase tracking-widest max-w-xs leading-relaxed">
                        Start by searching for advocates and sending connection requests to build your hub.
                    </p>
                    <a href="{{ route('support.search.advocates') }}" class="mt-8 px-8 py-4 rounded-xl bg-blue text-navy text-xs font-black uppercase tracking-[0.2em] hover:bg-blue2 hover:shadow-[0_0_30px_rgba(0,210,255,0.2)] transition-all duration-300">
