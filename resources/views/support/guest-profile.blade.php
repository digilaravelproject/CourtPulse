    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div class="lg:col-span-2 space-y-5 fu fu-2">
            ...
            <div class="rounded-2xl p-4" style="background:rgba(180,180,254,0.04);border:1px solid rgba(180,180,254,0.12)">
                <div class="flex gap-3"><i class="fas fa-info-circle text-blue mt-0.5 shrink-0" style="color:#B4B4FE"></i><p class="text-xs text-white/50 leading-relaxed">Guests can browse professionals and give feedback.</p></div>
            </div>
        </div>
