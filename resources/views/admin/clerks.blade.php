...
@section('page-title', 'Court Clerks')
...
@section('content')
    ...
    <div x-data="{
        ...
        load() {
            ...
            fetch('{{ route('admin.clerks') }}' + (qs ? '?' + qs : ''), {
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="flex items-center justify-between px-5 py-4 border-b border-slate-100">
                <h2 class="font-display font-bold text-[1.05rem] text-slate-800">All Court Clerks</h2>
            </div>
            <div id="clerk-tbl" class="overflow-x-auto">
                @include('admin.partials.clerks-table', ['clerks' => $clerks])
            </div>
        </div>
