    ...
    <style>
        * {
        ...
        #sidebar {
            ...
            background: #000000;
            background-image:
                radial-gradient(ellipse at 20% 50%, rgba(180, 180, 254, .06) 0%, transparent 60%),
        ...
        .nav-link.active {
            background: linear-gradient(135deg, rgba(180, 180, 254, .18), rgba(180, 180, 254, .08));
            color: #B4B4FE;
        ...
        .nav-link.active .nav-icon {
            background: rgba(180, 180, 254, .15)
        }
        ...
        .alert-info {
            background: rgba(180, 180, 254, .08);
            border-color: rgba(180, 180, 254, .3);
            color: #8A8AD6
        }
...
<body class="bg-slate-100 min-h-screen">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-screen z-40 flex flex-col">
        ...
        @if (auth()->user()->status === 'pending')
            <div class="mx-3 mt-3 rounded-xl px-3 py-2.5 flex gap-2 items-start"
                style="background:rgba(180,180,254,.08);border:1px solid rgba(180,180,254,.2)">
                <i class="bi bi-clock-history flex-shrink-0 mt-0.5" style="color:#B4B4FE;font-size:.8rem"></i>
                <p class="text-[.72rem] leading-snug" style="color:#B4B4FE">
        ...
        <div class="px-3 py-3" style="border-top:1px solid rgba(255,255,255,.07)">
            <div class="flex items-center gap-2.5 rounded-xl px-3 py-2.5"
                ...
                <div class="w-8 h-8 rounded-lg font-bold font-display text-sm flex items-center justify-center flex-shrink-0"
                    style="background:linear-gradient(135deg,#B4B4FE,#8A8AD6);color:#060C18">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="font-mono uppercase tracking-wider truncate"
                        style="font-size:.52rem;color:rgba(180,180,254,.5)">
    ...
    <header id="topbar"
        ...
        <div class="ml-auto flex items-center gap-2">
            ...
            <a href="{{ route('advocate.search.clerks') }}"
                ...
                style="background:#B4B4FE;color:#060C18" onmouseover="this.style.background='#8A8AD6'"
                onmouseout="this.style.background='#B4B4FE'">
                <i class="bi bi-plus-lg"></i> Find Clerk
            </a>

            <div class="relative">
                <button
                    class="w-9 h-9 rounded-lg border border-slate-200 bg-white flex items-center justify-center text-slate-500 hover:border-brand transition-all text-sm">
    ...
    <script>
        ...
        function showToast(msg, type = 'success') {
            ...
            t.style.cssText = type === 'success' ? 'background:#B4B4FE;color:#060C18' : 'background:#ef4444;color:white';
