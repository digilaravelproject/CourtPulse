...
<div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
    <div class="space-y-1">
        <h2 class="text-4xl font-black text-white uppercase tracking-tighter leading-tight">Professional <span class="text-blue-500">Dashboard</span></h2>
        <p class="text-xs font-bold text-white/30 uppercase tracking-[0.2em]">Overview of your performance & network status</p>
    </div>
            ...
            <div class="space-y-8">
                <div>
                    <div class="flex justify-between mb-3">
                        <span class="text-[10px] font-black text-white/40 uppercase tracking-widest">Profile Completion</span>
                ...
                <div>
                    <div class="flex justify-between mb-3">
                        <span class="text-[10px] font-black text-white/40 uppercase tracking-widest">Network Growth</span>
