...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-8 reveal">
    ...
    <div class="lg:col-span-8 space-y-8">
        <!-- Identity Card -->
        <div class="glass-dark rounded-4xl overflow-hidden border border-white/10">
            <div class="px-8 py-10 bg-linear-to-br from-indigo-500/10 via-transparent to-transparent">
        ...
        @if($targetUser->clerkProfile)
            <!-- Professional Details -->
            <div class="glass-dark rounded-4xl p-8 border border-white/10 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        <p class="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">Primary Designation</p>
                        <p class="text-base font-bold text-white">{{ $targetUser->clerkProfile->designation ?? 'Not specified' }}</p>
                    </div>
                    <div class="space-y-2">
                        <p class="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">Service Tenure</p>
                        <p class="text-base font-bold text-white">{{ $targetUser->clerkProfile->experience_years ?? 0 }} Years Experience</p>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="space-y-2">
                        ...
                        <p class="text-sm font-medium text-white/60 leading-relaxed italic">
                            "{{ $targetUser->clerkProfile->bio ?? 'No detailed biography provided for this professional.' }}"
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="lg:col-span-4 space-y-8">
        <!-- Reputation Card -->
        <div class="glass-dark rounded-4xl p-8 border border-white/10 text-center space-y-6">
        ...
        <!-- Connection Card -->
        @if(!$isConnected)
            <div class="glass-dark rounded-4xl p-8 border border-white/10 space-y-6 relative overflow-hidden">
        ...
        @else
            <div class="glass-dark rounded-4xl p-8 border border-white/10 space-y-6 bg-linear-to-br from-emerald-500/5 to-transparent">
