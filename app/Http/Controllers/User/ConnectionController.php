...
class ConnectionController extends Controller
{
    ...
    public function accept(ConnectionRequest $connectionRequest)
    {
        try {
            ...
            Log::error('Connection Accept Error: ' . $e->getMessage());
            return back()->withErrors(['general' => 'Failed to accept connection.']);
        }
    }
    ...
    public function reject(ConnectionRequest $connectionRequest)
    {
        try {
            ...
            Log::error('Connection Reject Error: ' . $e->getMessage());
            return back()->withErrors(['general' => 'Failed to reject connection.']);
        }
    }
    ...
    public function myConnections()
    {
        try {
            ...
            $layout = match (true) {
                $user->hasRole('super_admin') || $user->hasRole('admin') => 'layouts.admin',
            ...
            Log::error('My Connections Error: ' . $e->getMessage());
