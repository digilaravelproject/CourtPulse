...
class ClerkController extends Controller
{
    ...
    public function dashboard()
    {
        try {
            ...
            $data['hasFeedback'] = FeedbackController::clerkHasFeedback(Auth::id());
            $data['interestedAdvocates'] = User::with('advocateProfile')
                ->where('role', 'advocate')
                ->where('status', 'active')
                ->latest()->take(5)->get();
            ...
            Log::error('Clerk Dashboard Error: ' . $e->getMessage());
    ...
    public function profile()
    {
        try {
            ...
            Log::error('Clerk Profile View Error: ' . $e->getMessage());
    ...
    public function updateProfile(Request $request)
    {
        try {
            ...
            \App\Models\ClerkProfile::updateOrCreate(
                ['user_id' => $user->id],
                $validated
            );
    ...
    public function viewAdvocates(Request $request)
    {
        try {
            ...
            Log::error('Clerk View Advocates Error: ' . $e->getMessage());
    ...
    public function showAdvocate(User $user)
    {
        try {
            ...
            Log::error('Clerk Show Advocate Error: ' . $e->getMessage());
    ...
    public function browseGuests(Request $request)
    {
        try {
            ...
            Log::error('Clerk Browse Guests Error: ' . $e->getMessage());
    ...
    public function viewGuestProfile(User $user)
    {
        try {
            ...
            Log::error('Clerk View Guest Profile Error: ' . $e->getMessage());
