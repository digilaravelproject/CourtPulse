...
class SuperAdminController extends Controller
{
    ...
    public function dashboard()
    {
        try {
            ...
            return back()->withErrors(['general' => 'Failed to load super admin dashboard.']);
        }
    }
    ...
    public function activityLogs(Request $request)
    {
        try {
            ...
            Log::error('SuperAdmin Activity Logs Error: ' . $e->getMessage());
            return $request->ajax() 
                ? response()->json(['error' => 'Failed to load logs.'], 500)
                : back()->withErrors(['general' => 'Failed to load activity logs.']);
        }
    }
    ...
    public function allUsers(Request $request)
    {
        try {
            ...
            Log::error('SuperAdmin All Users Error: ' . $e->getMessage());
            return back()->withErrors(['general' => 'Failed to load users list.']);
        }
    }
    ...
    public function createAdmin(Request $request)
    {
        try {
            ...
            Log::error('SuperAdmin Create Admin Error: ' . $e->getMessage());
            return $request->ajax()
                ? response()->json(['success' => false, 'message' => $e->getMessage()], 500)
                : back()->withErrors(['general' => 'Failed to create admin.']);
        }
    }
    ...
    public function deleteUser(User $user)
    {
        try {
            ...
            Log::error('SuperAdmin Delete User Error: ' . $e->getMessage());
