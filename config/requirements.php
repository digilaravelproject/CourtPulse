...
return [
    'documents' => [
        'advocate' => [
            ...
            'aadhar_card' => ['label' => 'Aadhaar Card', 'icon' => 'bi-credit-card-2-front', 'required' => true],
        ...
        'clerk' => [
            'profile_photo' => ['label' => 'Profile Photo', 'icon' => 'bi-person-bounding-box', 'required' => true],
            'court_id_card' => ['label' => 'Court ID Card', 'icon' => 'bi-badge-ad', 'required' => true],
            'clerk_appointment_letter' => ['label' => 'Appointment Letter', 'icon' => 'bi-file-earmark-text', 'required' => true],
            'service_certificate' => ['label' => 'Service Certificate', 'icon' => 'bi-award', 'required' => true],
            'aadhar_card' => ['label' => 'Aadhaar Card', 'icon' => 'bi-credit-card-2-front', 'required' => true],
            'pan_card' => ['label' => 'PAN Card', 'icon' => 'bi-card-text', 'required' => true],
        ],
        'ca' => [
        ...
        'cs' => [
            'profile_photo' => ['label' => 'Profile Photo', 'icon' => 'bi-person-bounding-box', 'required' => true],
            'icsi_certificate' => ['label' => 'ICSI Membership Certificate', 'icon' => 'bi-patch-check', 'required' => true],
            'aadhar_card' => ['label' => 'Aadhaar Card', 'icon' => 'bi-credit-card-2-front', 'required' => true],
            'pan_card' => ['label' => 'PAN Card', 'icon' => 'bi-card-text', 'required' => true],
        ],
        'ip_attorney' => [
